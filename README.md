...
```javascript
rose = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-nightingales-rose@v0.3.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-nightingales-rose@v0.3.0-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/datasets-nightingales-rose/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/datasets-nightingales-rose/actions/workflows/test.yml?query=branch:v0.3.0
